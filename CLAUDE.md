...
- **触及具体章节**：将提炼后的要点追加到 `raw/chapter-XX.md`
- **跨章节的哲学/技术讨论**：新建 `raw/topic-<主题>.md`，包含触发点、讨论要点、待继续思考
- **更新项目状态**：修改 `memory/project-state.md` 中的"进行中的讨论"和"待办"
- **提交**：笔记文件和状态文件一起 commit

文件命名：
- `raw/chapter-XX.md` — 按章节组织的个人笔记
- `raw/topic-<slug>.md` — 跨章节专题讨论（如 topic-the-ultimate-purpose-of-ai.md）
